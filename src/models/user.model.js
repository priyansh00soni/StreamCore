...
const userSchema = new Schema(
    {
        ...
        watchHistory: [
            // this will be an array that stores the id of the videos that were watched.
            {
...
userSchema.pre('save', async function () {
    // don't use arrow fn here as they don't have their own this keyword.
...
userSchema.methods.isPasswordCorrect = async function (password) {
    // Every user document (object) created from this schema should have this method.
