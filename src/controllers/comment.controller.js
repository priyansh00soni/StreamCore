...
const deleteComment = asyncHandler(async (req, res) => {
    ...
    const comment = await Comment.findOneAndDelete({owner:req.user._id,_id:commentId})

    if(!comment) throw new ApiError(500,"Something went wrong while deleting the Comment")
