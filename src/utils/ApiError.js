class ApiError extends Error{ // We are basically creating a child class of Node.JS's parent error class. We do this so that the structure of error that we will provide will stay professional everywhere . So We enforce a uniform error format. Whenever something goes wrong in my API, I don’t want random errors. I want a structured failure object that frontend can always understand.
    constructor(
        statusCode,
